...
This blog uses the [**Chirpy**](https://github.com/cotes2020/jekyll-theme-chirpy/) template.
...
2. Browse to your repository on GitHub and choose the branch `gh-pages` as the [publishing source](https://docs.github.com/en/github/working-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site)
